...
- Technical trend tag (SIGNAL column): 50/200d SMA trend regime + RSI(14) → BUY / WATCH / FLAT / SELL / N/A (insufficient history). Informational only, not part of the score.
